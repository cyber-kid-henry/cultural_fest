...
var messages = [
  " Indian dance traces back thousands of years to temple rituals and sacred texts like the Natya Shastra",
  "Many classical dances began as offerings to deities in temples",
  " Indian dance is performed and admired worldwide.",
  "Dance unites people across languages and regions",
  "Loading ExZ with New Dance Theme",
  "Hover over dance froms for more magic...",
  "Let's Dance",
].reverse();
